            ...
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <a href="/hotelluna/views/usuarios/registrar.php" class="btn btn-primary btn-sm float-right">
                                    ...
                                    <?php foreach ($usuarios as $i => $col): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Cambiar estado -->
                                                <form action="/hotelluna/views/usuarios/cambiar_estado.php" method="POST" style="display:inline;">
                                                ...
                                                <!-- Eliminar usuario -->
                                                <form action="/hotelluna/views/usuarios/eliminar.php" method="POST" style="display:inline;" onsubmit="return confirmarEliminacion();">
                                                    <input type="hidden" name="idusuario" value="<?= $col['idusuario'] ?>">
                                                ...
                                                <form action="/hotelluna/views/usuarios/restablecer_password.php" method="POST" style="display:inline;" onsubmit="return confirmarRestablecer();">
                                                    <input type="hidden" name="idusuario" value="<?= $col['idusuario'] ?>">
