                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="tablaHabitaciones">
                                ...
                                <tbody>
                                    <?php if (isset($habitaciones) && is_array($habitaciones)): ?>
                                        <?php foreach ($habitaciones as $hab): ?>
                                            <?php if ($hab['estado'] === 'ocupada' || $hab['estado'] === 'mantenimiento'): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="detalle_habitacion.php?numero=<?= urlencode($hab['numero']) ?>" class="btn btn-sm btn-outline-info">
                                                            Ver Detalle
                                                        </a>
                                                    </td>
                                                </tr>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="4">No hay habitaciones ocupadas ni en mantenimiento.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
